	...
	return (
		<>
			...
			>
				...
				<p className='text-white font-medium text-base tracking-normal 2xl:text-xl 3xl:text-3xl'>{t('buttonLeft')}</p>
			</button>
			<button
				type='button'
			...
			>
				...
				<p className='text-white font-medium tracking-normal text-base 2xl:text-xl 3xl:text-3xl'>{t('buttonRight')}</p>
			</button>
		</>
	)
}
